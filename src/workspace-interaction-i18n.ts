...
const en = {
  ...
  permissionMode: "Permissions", permissionAsk: "Ask", permissionAuto: "Auto allow", permissionAskHint: "Ask before page changes, screenshots and local tool approvals.",
  permissionAutoHint: "YOLO: approve tool operations in this conversation automatically. Questions still need an answer. Sensitive-field restrictions and agent policies still apply.",
...
const translations: Record<SupportedLanguage, Record<InteractionKey, string>> = {
  ...
  zh_CN: {
    ...
    permissionMode: "操作授权", permissionAsk: "询问", permissionAuto: "自动允许", permissionAskHint: "网页修改、截图及本地工具需要授权时，先询问你。",
    permissionAutoHint: "YOLO：自动批准当前会话的工具操作；澄清问题仍需回答。敏感字段限制和智能体自身的权限规则仍然有效。",
  ...
  zh_TW: {
    ...
    permissionMode: "操作授權", permissionAsk: "詢問", permissionAuto: "自動允許", permissionAskHint: "網頁修改、截圖及本機工具需要授權時，先詢問你。",
    permissionAutoHint: "YOLO：自動批准目前會話的工具操作；釐清問題仍需回答。敏感欄位限制與智慧體本身的權限規則仍然有效。",
  ...
  ja: {
    ...
    permissionMode: "操作の許可", permissionAsk: "確認する", permissionAuto: "自動許可", permissionAskHint: "ページの変更、スクリーンショット、ローカルツールの許可を確認します。",
    permissionAutoHint: "YOLO：この会話のツール操作を自動で許可します。質問への回答は必要です。機密入力欄の制限とエージェントの権限ルールは維持されます。",
  ...
  de: {
    ...
    permissionMode: "Berechtigungen", permissionAsk: "Nachfragen", permissionAuto: "Automatisch erlauben", permissionAskHint: "Vor Seitenänderungen, Screenshots und lokalen Tool-Freigaben nachfragen.",
    permissionAutoHint: "YOLO: Tool-Aktionen in dieser Unterhaltung automatisch erlauben. Fragen erfordern weiterhin eine Antwort. Regeln für sensible Felder und Agent-Berechtigungen bleiben bestehen.",
  ...
  pt_BR: {
    ...
    permissionMode: "Permissões", permissionAsk: "Perguntar", permissionAuto: "Permitir automaticamente", permissionAskHint: "Perguntar antes de alterações na página, capturas de tela e aprovações de ferramentas locais.",
    permissionAutoHint: "YOLO: aprovar automaticamente as operações de ferramentas nesta conversa. Perguntas ainda precisam de resposta. Restrições de campos sensíveis e regras do agente continuam válidas.",
