...
const en = {
  ...
  readingStatus: "Reading local connection status…", connectOrca: "Sign in to OrcaRouter",
  orcaAffiliateDisclosure: "Referral sign-in: if you register through this entry, later qualifying purchases may earn the WebAgentMate developers a commission.",
  verify: "Verify connection", disconnect: "Disconnect", privacyTitle: "Local-first privacy",
  privacyCopy: "The authorization key is kept in Chrome extension storage restricted to trusted extension contexts. It is not sent to WebAgentMate servers or persisted by Connector. You can revoke it from OrcaRouter Authorized Apps.",
  ...
  connectedNoBridge: "The full remote agent is ready without Connector. Only local CLI tools are unavailable.",
  disconnectedNoBridge: "Connect OrcaRouter to use the remote agent. Connector is only needed for local CLI tools.",
  connectedWithBridge: "OrcaRouter is connected and Connector {version} is available.",
  ...
  remoteModelsDescription: "No Connector required. The agent can read, summarize, translate, and operate the current page.", localAgentsDescription: "Page context is passed to the selected local CLI through Connector.",
  ...
  agentDescription: "The built-in agent can inspect and operate the current page without Connector.",
...
const zhCN: Dictionary = {
  ...
  connectOrca: "登录 OrcaRouter", verify: "验证连接", disconnect: "断开连接", privacyTitle: "本地优先隐私",
  orcaAffiliateDisclosure: "推广登录：通过此入口注册，后续符合条件的消费可能为 WebAgentMate 开发者带来佣金。",
  privacyCopy: "授权 Key 保存在 Chrome 扩展的本地可信存储区，不会发送到 WebAgentMate 服务器，连接助手也不会持久化它。你可以在 OrcaRouter 的 Authorized Apps 中撤销授权。",
  ...
  connectedNoBridge: "无需 连接助手，远端智能体已可完整使用；仅本地 CLI 工具不可用。",
  disconnectedNoBridge: "连接 OrcaRouter 即可使用远端智能体；只有本地 CLI 工具需要 连接助手。",
  connectedWithBridge: "OrcaRouter 已连接，连接助手 {version} 可用。", readyWithBridge: "登录并授权 WebAgentMate；Key 将保存在扩展的本地可信存储区。",
  ...
  remoteModelsDescription: "无需 连接助手。智能体可读取、总结、翻译并操作当前网页。", localAgentsDescription: "网页内容会通过 连接助手 交给所选本地 CLI。",
  ...
  agentDescription: "内置 Agent 无需 连接助手 即可理解并操作当前网页。", agentPlaceholder: "提问，或描述希望在网页上完成的事情…",
...
const zhTW: Dictionary = {
  ...
  connectOrca: "登入 OrcaRouter", verify: "驗證連線", disconnect: "中斷連線", privacyTitle: "本機優先隱私",
  orcaAffiliateDisclosure: "推廣登入：透過此入口註冊，後續符合條件的消費可能為 WebAgentMate 開發者帶來佣金。",
  privacyCopy: "授權金鑰保存在 Chrome 擴充功能的本機可信儲存區，不會傳送到 WebAgentMate 伺服器，連線助手也不會永久保存。你可以在 OrcaRouter Authorized Apps 中撤銷授權。",
  ...
  connectedNoBridge: "無需 連線助手，遠端智慧體已可完整使用；僅本機 CLI 工具不可用。",
  disconnectedNoBridge: "連線 OrcaRouter 即可使用遠端智慧體；只有本機 CLI 工具需要 連線助手。",
  connectedWithBridge: "OrcaRouter 已連線，連線助手 {version} 可用。", readyWithBridge: "登入 OrcaRouter；金鑰將保存在擴充功能的本機可信儲存區。",
  ...
  remoteModelsDescription: "無需 連線助手。智慧體可讀取、摘要、翻譯並操作目前網頁。", localAgentsDescription: "網頁內容會透過 連線助手 交給所選本機 CLI。",
  ...
  agentDescription: "內建 Agent 無需 連線助手 即可理解並操作目前網頁。", agentPlaceholder: "提問，或描述希望在網頁上完成的事情…",
...
const ja: Dictionary = {
  ...
  connectOrca: "OrcaRouter にログイン", verify: "接続を確認", disconnect: "接続を解除", privacyTitle: "ローカル優先のプライバシー",
  orcaAffiliateDisclosure: "紹介付きサインイン：この入口から新規登録すると、その後の対象となる購入により、WebAgentMateの開発者が紹介報酬を受け取る場合があります。",
  privacyCopy: "認証キーは、信頼された拡張機能コンテキストに限定されたChromeのローカルストレージに保存されます。WebAgentMateサーバーには送信されず、接続アシスタントにも永続保存されません。OrcaRouterのAuthorized Appsから取り消せます。",
  ...
  connectedNoBridge: "接続アシスタントなしでリモートAgentを利用できます。ローカルCLIツールのみ利用できません。",
  disconnectedNoBridge: "OrcaRouterに接続するとリモートAgentを利用できます。接続アシスタントはローカルCLIにのみ必要です。",
  connectedWithBridge: "OrcaRouterに接続済みで、接続アシスタント {version}を利用できます。", readyWithBridge: "OrcaRouterにサインインしてください。キーは拡張機能の信頼済みローカルストレージに保存されます。",
  ...
  remoteModelsDescription: "接続アシスタントは不要です。Agentは現在のページを読み、要約・翻訳・操作できます。", localAgentsDescription: "ページ内容は接続アシスタント経由で選択したローカルCLIに渡されます。",
  free: "無料", paid: "有料", back: "戻る", settingsNavigation: "設定セクション", about: "アプリ情報",
  ...
  agentDescription: "内蔵Agentは接続アシスタントなしで現在のページを理解・操作できます。", agentPlaceholder: "質問またはページで行うタスクを入力…",
...
const de: Dictionary = {
  ...
  connectOrca: "Bei OrcaRouter anmelden", verify: "Verbindung prüfen", disconnect: "Trennen", privacyTitle: "Lokaler Datenschutz",
  orcaAffiliateDisclosure: "Anmeldung mit Partnerempfehlung: Wenn Sie sich über diesen Zugang registrieren, können spätere qualifizierte Käufe den WebAgentMate-Entwicklern eine Provision einbringen.",
  privacyCopy: "Der Autorisierungsschlüssel wird im lokalen Chrome-Erweiterungsspeicher nur für vertrauenswürdige Erweiterungskontexte gespeichert. Er wird weder an WebAgentMate-Server gesendet noch vom Verbindungshelfer dauerhaft gespeichert. Der Zugriff kann in OrcaRouter Authorized Apps widerrufen werden.",
  ...
  connectedNoBridge: "Der Remote-Agent ist ohne Verbindungshelfer einsatzbereit. Nur lokale CLI-Werkzeuge sind nicht verfügbar.",
  disconnectedNoBridge: "OrcaRouter verbindet den Remote-Agent. Der Verbindungshelfer wird nur für lokale CLI-Werkzeuge benötigt.",
  connectedWithBridge: "OrcaRouter ist verbunden und der Verbindungshelfer {version} ist verfügbar.", readyWithBridge: "Bei OrcaRouter anmelden. Der Schlüssel bleibt im vertrauenswürdigen lokalen Erweiterungsspeicher.",
  ...
  remoteModelsDescription: "Kein Verbindungshelfer erforderlich. Der Agent kann die Seite lesen, zusammenfassen, übersetzen und bedienen.", localAgentsDescription: "Der Seitenkontext wird über den Verbindungshelfer an die gewählte lokale CLI übergeben.",
  ...
  agentDescription: "Der integrierte Agent versteht und bedient die Seite auch ohne Verbindungshelfer.", agentPlaceholder: "Frage stellen oder eine Seitenaufgabe beschreiben…",
...
const ptBR: Dictionary = {
  ...
  connectOrca: "Entrar no OrcaRouter", verify: "Verificar conexão", disconnect: "Desconectar", privacyTitle: "Privacidade local",
  orcaAffiliateDisclosure: "Login com indicação: se você se cadastrar por esta opção, compras futuras elegíveis poderão gerar uma comissão para os desenvolvedores do WebAgentMate.",
  privacyCopy: "A chave de autorização fica no armazenamento local do Chrome, restrito aos contextos confiáveis da extensão. Ela não é enviada aos servidores do WebAgentMate nem persistida pelo assistente de conexão. Você pode revogá-la em Authorized Apps no OrcaRouter.",
  ...
  connectedNoBridge: "O agente remoto está pronto sem o assistente de conexão. Apenas as ferramentas de CLI local estão indisponíveis.",
  disconnectedNoBridge: "Conecte o OrcaRouter para usar o agente remoto. O assistente de conexão só é necessário para CLIs locais.",
  connectedWithBridge: "O OrcaRouter está conectado e o assistente de conexão {version} está disponível.", readyWithBridge: "Entre no OrcaRouter. A chave ficará no armazenamento local confiável da extensão.",
  ...
  remoteModelsDescription: "Não requer assistente de conexão. O agente pode ler, resumir, traduzir e operar a página atual.", localAgentsDescription: "O contexto da página passa pela assistente de conexão para a CLI local escolhida.",
  ...
  agentDescription: "O agente integrado entende e opera a página sem o assistente de conexão.", agentPlaceholder: "Pergunte ou descreva uma tarefa na página…",
