...
WebAgentMate helps a user understand the webpage they are actively viewing through summaries, translations, explanations, key points, and contextual questions.
...
- `scripting`: extracts visible text from the active page only after the user clicks **Read current page**.
